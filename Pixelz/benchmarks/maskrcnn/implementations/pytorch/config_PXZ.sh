...
: "${HYBRID_LOADER:=True}"
: "${SOLVER_MAX_ITER:=18000}"

export EXTRA_PARAMS=""
export EXTRA_CONFIG='SOLVER.BASE_LR 0.16 SOLVER.WARMUP_FACTOR 0.000192 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD linear SOLVER.STEPS (9000,12000) SOLVER.IMS_PER_BATCH 128 TEST.IMS_PER_BATCH 128 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 16000 MODEL.RPN.FPN_POST_NMS_TOP_N_PER_IMAGE False NHWC True'
